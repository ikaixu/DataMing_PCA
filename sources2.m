...
%4阶近邻
            if class1~=class2 && class2==class3 && class3==class4 && class3~=class4
              class = class2;
            elseif class2==class3 && class1~=class2 && class1~=class4 && class2~=class4
                class=class2;
            elseif class2==class4 && class1~=class2 && class1~=class3 && class3==class4
                class=class2;
            elseif class3==class4 && class1~=class4 && class1~=class2 && class2~=class4
                class=class3;
            else
                class=class1;
            end;
